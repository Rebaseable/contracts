...
import {ScrollMessenger} from "./StETHBridge.sol";
import {IScrollRstETH} from "./StETHBridge.sol";
...
contract ScrollRstETH is ERC20, IScrollRstETH {
    ...
    function dummyMint(address account, uint256 value) external {
        _mint(account, value);
    }

    function balanceOf(address account) public view virtual override returns (uint256) {
        return getPooledEthByShares(sharesPerUser[account]);
    }
